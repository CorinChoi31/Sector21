...
function tower_init() {
	...
	#region 3 Debuff Attack
		...
		tower_define(3, 1, c_blue, 45, 90,
			7, 2, 2, 1, 7, 25,
			5, 2, -0.125, 0.5, 0.75);
			global.tower_info[? "3,1"+"."+"description"] = "단일 대상 | 광역 피해 | 광역 정지";
		...
		tower_define(3, 3, c_blue, 90, 90,
			10, 5, 5, 10, 1.5, 0,
			5, 2, -0.2, 2, 0.25);
			global.tower_info[? "3,3"+"."+"description"] = "사거리 내에 적이 있을 경우 광역 피해 및 정지";
	#endregion
