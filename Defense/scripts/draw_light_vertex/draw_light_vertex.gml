/// @fuction draw_light_vertex(x, y, range, ltlength, lplength, ltangle, color, ltcolor, alpha, ltalpha, lpalpha, rotate)
/// @description
/// @param x
/// @param y
/// @param range
...
function draw_light_vertex(_x, _y, _range, _ltlength, _lplength, _ltangle, _color, _ltcolor, _alpha, _ltalpha, _lpalpha, _rotate)
{
	var _angle = 0;
	...
	for(_angle = _rotate; _angle < 360+_rotate; _angle += 90)
	{
		...
		draw_primitive_begin(pr_trianglelist);
			...
			draw_vertex_color(
				_x + _sx + lengthdir_x(_lplength, _angle+_ltangle), 
				_y + _sy + lengthdir_y(_lplength, _angle+_ltangle), 
				_ltcolor, _lpalpha
			);
			draw_vertex_color(
				_x + _ex + lengthdir_x(_ltlength, _angle-_ltangle), 
		...
		draw_primitive_begin(pr_trianglelist);
			...
			draw_vertex_color(
				_x + _ex + lengthdir_x(_lplength, _angle-_ltangle), 
				_y + _ey + lengthdir_y(_lplength, _angle-_ltangle), 
				_ltcolor, _lpalpha
			);
			draw_vertex_color(
				_x + _sx + lengthdir_x(_lplength, _angle+_ltangle), 
